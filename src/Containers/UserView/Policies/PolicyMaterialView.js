...
class UserPolicyMaterialView extends Component {
  state = {
    numPages: null,
    pageNumber: 1,
  }
...
const withForm = reduxForm(
  {
    form: 'UserPolicyMaterialView',
  },
  UserPolicyMaterialView,
);

UserPolicyMaterialView.propTypes = {
  user: PropTypes.object,
  material: PropTypes.object,
};

export default compose(connect(mapStateToProps), withForm)(UserPolicyMaterialView);
